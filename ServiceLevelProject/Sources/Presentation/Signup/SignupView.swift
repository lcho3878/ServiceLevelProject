...
final class SignupView: BaseView {
    ...
    private lazy var emailTextField = signupTextField(placeholder: "이메일을 입력하세요")
    private let emailValidationButton = BrandColorButton(title: "중복 확인")
    private lazy var nicknameLabel = signupLabel(title: "닉네임")
    private lazy var nicknameTextField = signupTextField(placeholder: "닉네임을 입력하세요") 
    private lazy var contactLabel = signupLabel(title: "연락처")
    private lazy var contactTextField = signupTextField(placeholder: "전화번호를 입력하세요")
    private lazy var passwordLabel = signupLabel(title: "비밀번호")
    private lazy var passwordTextField = signupTextField(placeholder: "비밀번호를 입력하세요")
    private lazy var passwordCheckLabel = signupLabel(title: "비밀번호 확인")
    private lazy var passwordCheckTextField = signupTextField(placeholder: "비밀번호를 한 번 더 입력하세요")
...
extension SignupView {
    ...
    private func signupTextField(placeholder: String) -> UITextField {
